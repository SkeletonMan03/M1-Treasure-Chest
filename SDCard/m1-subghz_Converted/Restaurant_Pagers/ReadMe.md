# This was converted from https://github.com/UberGuidoZ/Flipper/tree/main/Sub-GHz/Restaurant_Pagers and below is the original ReadMe.md (with an updated link)
